...
<html lang="en">
  ...
  <div class="form-group row">
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="password" class="form-control" id="inputPassword" placeholder="Re-Password" name="Re-Password">
  </div>
</div>
<div class="form-group row">
	<div class="col-sm-10">
...
if (isset($_POST['submit'])) {
  session_start();
  $query = mysqli_connect($conn,"SELECT * FROM user");
  while ($oke['name']== $_POST['username']&$acc['pass']==$_POST['password']) {
